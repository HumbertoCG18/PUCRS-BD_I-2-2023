...
CREATE TABLE pedidos ( 
    ...
    CONSTRAINT fk_peca FOREIGN KEY (PecaID, CategoriaID) REFERENCES pecas(PecaID, CategoriaID) 
)
;
...
BEGIN  
    SELECT Estoque INTO v_pode_registrar FROM pecas WHERE PecaID = :NEW.peca_id AND CategoriaID = :NEW.categoria_id;  
